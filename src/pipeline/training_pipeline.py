...
from src.exception.exception_handler import RaiseException
import sys,os
...
# from src.model_pusher.model_pusher import ModelPusher
# from src.cloud_storage.s3_syncer import S3Sync
# from src.constant.s3_bucket import TRAINING_BUCKET_NAME
from src.constant.constant_names import SAVED_MODEL_DIR
...
class TrainPipeline:
    ...
    def start_data_ingestion(self)->DataIngestionArtifact:
        try:
            ...
            data_ingestion_artifact = data_ingestion.initiate_data_ingestion()          #returning data ingestion artifact
            logging.info(f"Data ingestion completed and artifact: {data_ingestion_artifact}")
            return data_ingestion_artifact
        except  Exception as e:
            raise  RaiseException(e,sys)
